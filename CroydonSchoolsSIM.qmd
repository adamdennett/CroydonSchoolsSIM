...
ggplot(Flows_by_100mdist, aes(distance_100m, flow)) + geom_line() + scale_x_continuous(breaks = seq(0, 50, by = 1)) + labs(title = "Pupil Flows by Distance to School", x = "Distance (km)", y = "Pupil Count")

ggplot(Flows_by_500mdist, aes(distance_500m, flow)) + geom_line() + scale_x_continuous(breaks = seq(0, 50, by = 1)) + labs(title = "Pupil Flows by Distance to School", x = "Distance (km)", y = "Pupil Count")
